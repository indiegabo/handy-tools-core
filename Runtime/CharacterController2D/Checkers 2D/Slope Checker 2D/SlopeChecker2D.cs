...
namespace IndieGabo.CharacterController2D.Checkers2D
{
    ...
    public class SlopeChecker2D : Checker2D, ISlopeDataProvider
    {
        #region Inspector
        ...
        [Foldout("Seekers")]
        [Tooltip("If you guarantee your GameObject has a component wich implements an IFacingDirectionProvider you can mark this and it will subscribe to its events. PCActions implements it.")]
        [SerializeField] protected bool seekFacingDirectionProvider = false;

        [Foldout("Seekers")]
        [Tooltip("If you guarantee your GameObject has a component wich implements an IGroundingProvider you can mark this and it will subscribe to its events. GroundingChecker2D implements it.")]
        ...
        protected IFacingDirectionProvider facingDirectionProvider; // Receives info about GameObject's movement direction.
        ...
        protected virtual void SubscribeSeekers()
        {
            ...
            if (seekFacingDirectionProvider)
            {
                ...
                facingDirectionProvider?.DirectionFacingUpdate.AddListener(UpdateFacingDirection);
            }
            ...
            if (seekGroundingProvider)
            {
                ...
                if (groundingProvider == null)
                    Debug.LogWarning("Component SlopeChecker2D might not work properly. It is marked to seek for an IGroundingProvider but it could not find any.");
        ...
        protected virtual void UnsubscribeSeekers()
        {
            ...
            facingDirectionProvider?.DirectionFacingUpdate.RemoveListener(UpdateFacingDirection);
        }
